...
function Student(inputExpertise) {
	this.expertise = inputExpertise
	this.knowledge = 0
	this.learn = function(inputLearnAmount){
		this.knowledge += inputLearnAmount
	}
}
...
function Safe(newSecret, instanceOfKey){
	var secretVariable = newSecret
	var secretKey = instanceOfKey
	this.unlock = function(inputKey){
		if (inputKey === instanceOfKey) {
			return secretVariable
		}
	}
}
...
function Validator() {
	this.email = function(emailString) {
